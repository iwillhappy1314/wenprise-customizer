...
class Frontend
{
    ...
    public static function get_container_css()
    {
        ...
        $css .= sprintf(
            ...
            .container, .site__content, .post-type-archive .site__shop, .tax-product_cat .site__shop, .tax-product_tag .site__shop, .single-product .archive-header .woocommerce-breadcrumb, .related.products, .upsells.products
             { max-width: %dpx; } }',
            $container_width
        );
